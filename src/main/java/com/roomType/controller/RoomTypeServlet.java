...
// 或 【/hostel/listRoomTypes_ByHostelNo.jsp】 或 【 /hostel/hostel_listHostelsForRoomTypes.jsp】
...
//			System.out.println("whichPage="+whichPage);
		//改轉到當前頁面，並把set民宿房型傳給特定2個頁面，其它則是不變
			...
			// 送出刪除的來源網頁的第幾頁(只用於:listAllEmp.jsp)
...
//			Map<String, String[]> map=req.getParameterMap();
				HttpSession session =req.getSession();
			//先放在取，同reference errorMsgs to errorMsgs list,so everytime change can
			//refer to req's errorMsgs
