...
<%-- 									value="${(roomTypeVO==null)?"2001":roomTypeVO.getHostelNo()}"> --%>
						...
						<div class="form-group">
								...
								<input type="text" id="facilityNo" name="facilityNo" size="45" class="form-control"
									value="${(roomTypeVO==null)?"4001":roomTypeVO.getFacilityNo()}">
						</div>
							...
							<div class="form-group">
								...
								<input type="file" id="roomTypePicture" name="roomTypePicture" size="45" class="form-control"
									value="${(roomTypeVO==null)?null:roomTypeVO.getRoomTypePicture()}">
							</div>
